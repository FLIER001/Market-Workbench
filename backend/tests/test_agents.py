...
def test_public_news_search_parses_and_caps_rss(monkeypatch):
    import requests

    xml = b"""<?xml version="1.0" encoding="utf-8"?>
    <rss><channel>
      <item><title>Major &amp; verified</title><link>https://example.com/a</link>
      <description><![CDATA[<b>Independent</b> follow-up]]></description><pubDate>today</pubDate></item>
      <item><title>Second</title><link>https://example.org/b</link><description>More</description></item>
    </channel></rss>"""
    ...
    out = tools.public_news_search("  company   major event  ", count=1)

    assert out["query"] == "company major event"
    assert out["results"] == [{
        "title": "Major & verified",
        "url": "https://example.com/a",
        "snippet": "Independent follow-up",
        "published": "today",
        "source": "example.com",
    }]
