...
>
> 每日复盘、资讯雷达、个股数据、自选（自选股 / 自选 ETF）、板块中心、板块评分、我的持仓、我的研报、研究记录。把数据和功能配齐，由**你自己的 AI** 驱动投资研究。
...
| 🔍&nbsp;**个&#8288;股&#8288;数&#8288;据** | **A 股**：行情 · **前复权 K 线**（日/周/月、MA5/10/20、成交量）· 估值矩阵（前向 PE / PEG）· **财报速览** · 估值历史分位 · 财务关键指标 · 研报 · 公告 · 新闻 · **资金面**（融资融券 / 股东户数 / 主力资金流 / 分红 / 大宗交易）· 龙虎榜 · 限售解禁 · 板块归属 · 热门概念 · 互动易问答。**美股 / 港股 / 韩股**（输 `AAPL` / `00700` / `005930.KS`）：行情 · 总市值 · 关键财务指标（营收 / 净利 / EPS / ROE / 毛利率 / 负债率；韩股仅行情）|
| ⭐&nbsp;**自&#8288;选** | **自选股 / 自选 ETF 两套独立清单** · 各自支持自定义分组、组间移动与分组拖动排序 · **批量粘贴一串代码即加** · 一屏表格总览（现价 / 涨跌 / PE / PB / 换手）· **实时行情开关**（交易时段每 3 秒）· 一键按分组交给 AI 读。只存本地 |
| 🧩&nbsp;**板&#8288;块&#8288;中&#8288;心** | 20 个赛道的产业链研究页 · 核心环节可展开到代表企业并下钻个股数据 · 未来利好/利空触发器 · 当前政策信号与官方证据 · 近期公开资讯 |
| 🎛️&nbsp;**板&#8288;块&#8288;评&#8288;分** | 申万一级行业综合观察：申万成分分类 × 腾讯个股行情聚合当日 PE/PB、涨幅与活跃度 · 申万月报历史锚 · 集中风险扣分 |
| 💼&nbsp;**我&#8288;的&#8288;持&#8288;仓** | 录入即实时盈亏 · 已清仓记录（只存本地、不上传）|
| 📄&nbsp;**我&#8288;的&#8288;研&#8288;报** | **拖拽 / 多选上传**自己的研报（PDF / Word / txt / 表格 / 图片）· 按文件名**自动分行业**归档 · 下载 / 删除。**只存本地部署目录、不上传、不进仓库** |
| 📝&nbsp;**研&#8288;究&#8288;记&#8288;录** | 复盘 / 今日要点 / 问 AI 结果本地沉淀，随时回看 · **反思审计**：让 AI 回头审这段推理——哪些结论有数据撑着、哪些是脑补、最脆弱的一环在哪、要验证得看什么 |
